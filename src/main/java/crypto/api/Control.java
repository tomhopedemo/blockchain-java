 ...
 *  referendum to be modified to have a question field, let the name to be generated, and renamed to stockKey. potentially rename referendum to question
 ...
 *  generic cache
 *  miner to check if block type alowed
 */
